...
def write_human_log(
    ...
    *,
    ...
    lines = [
        ...
        f"Model locations config status: {session.model_locations_config_status}",
        f"Runtime endpoint config status: {session.runtime_endpoint_config_status}",
        ...
        f"Control Center runtime status: {session.control_center_runtime_status}",
        f"Control Center launch status: {session.control_center_launch_status}",
        ...
        f"Model locations config path: {session.model_locations_config_path}",
        f"Runtime metadata path: {session.runtime_metadata_path}",
        f"Runtime endpoint config path: {session.runtime_endpoint_config_path}",
        ...
        f"Managed runtime port: {session.managed_runtime_port}",
        ...
        f"TurboQuant artifact id: {session.turboquant_artifact_id}",
        f"TurboQuant artifact path: {session.turboquant_artifact_path}",
        f"TurboQuant metadata path: {session.turboquant_metadata_path}",
        f"TurboQuant executable path: {session.turboquant_executable_path}",
        f"TurboQuant error: {session.turboquant_error}",
        f"Control Center executable path: {session.control_center_executable_path}",
        f"Control Center launcher path: {session.control_center_launcher_path}",
        f"Control Center URL: {session.control_center_url}",
        f"Control Center port: {session.control_center_port}",
...
def write_json_report(
    ...
    *,
    ...
    payload = {
        ...
        "model_locations_config_status": session.model_locations_config_status,
        "runtime_endpoint_config_status": session.runtime_endpoint_config_status,
        ...
        "control_center_runtime_status": session.control_center_runtime_status,
        "control_center_launch_status": session.control_center_launch_status,
        ...
        "model_locations_config_path": session.model_locations_config_path,
        "runtime_metadata_path": session.runtime_metadata_path,
        "runtime_endpoint_config_path": session.runtime_endpoint_config_path,
        ...
        "managed_runtime_port": session.managed_runtime_port,
        ...
        "turboquant_artifact_id": session.turboquant_artifact_id,
        "turboquant_artifact_path": session.turboquant_artifact_path,
        "turboquant_metadata_path": session.turboquant_metadata_path,
        "turboquant_executable_path": session.turboquant_executable_path,
        "turboquant_error": session.turboquant_error,
        "control_center_executable_path": session.control_center_executable_path,
        "control_center_launcher_path": session.control_center_launcher_path,
        "control_center_url": session.control_center_url,
        "control_center_port": session.control_center_port,
