...
def write_human_log(
    ...
    *,
    ...
    lines = [
        ...
        f"RuntimePilot runtime status: {session.control_center_runtime_status}",
        f"RuntimePilot launch status: {session.control_center_launch_status}",
        ...
        f"RuntimePilot executable path: {session.control_center_executable_path}",
        f"RuntimePilot launcher path: {session.control_center_launcher_path}",
        f"RuntimePilot URL: {session.control_center_url}",
        f"RuntimePilot port: {session.control_center_port}",
