...
Ova checklist-a je namenjena za stvarno korisnicko testiranje Windows proizvoda iz grane `codex/panel-integration`, nakon release-a `v0.4.37`.
...
1. Preuzmi aktuelni installer:
   - `LocalAIControlCenterSetup-v0.4.37.exe`
