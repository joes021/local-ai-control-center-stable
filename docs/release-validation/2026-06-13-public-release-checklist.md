...
Date: 2026-06-13
Version target: `v0.4.94`
Installer target: `dist/RuntimePilotSetup-v0.4.94.exe`
...
- [ ] Upload `dist/RuntimePilotSetup-v0.4.94.exe` and `dist/RuntimePilotSetup-latest.exe` only after final smoke test.
